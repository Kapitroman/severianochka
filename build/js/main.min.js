...
/* harmony import */ var _modules_show_authorized_menu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/show-authorized-menu */ "./js/modules/show-authorized-menu.js");
/* harmony import */ var _modules_init_banner_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-banner-slider */ "./js/modules/init-banner-slider.js");
/* harmony import */ var _modules_init_list_cards_slider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-list-cards-slider */ "./js/modules/init-list-cards-slider.js");
/* harmony import */ var _modules_init_list_articles_slider__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/init-list-articles-slider */ "./js/modules/init-list-articles-slider.js");
/* harmony import */ var _modules_init_special_banners_slider__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/init-special-banners-slider */ "./js/modules/init-special-banners-slider.js");
/* harmony import */ var _modules_init_product_count__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/init-product-count */ "./js/modules/init-product-count.js");
/* harmony import */ var _modules_init_favourite_click__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/init-favourite-click */ "./js/modules/init-favourite-click.js");
/* harmony import */ var _modules_remove_focus__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/remove-focus */ "./js/modules/remove-focus.js");
/* harmony import */ var _modules_init_cart_button_click__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/init-cart-button-click */ "./js/modules/init-cart-button-click.js");
/* harmony import */ var _modules_init_tabs__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/init-tabs */ "./js/modules/init-tabs.js");
/* harmony import */ var _modules_init_map__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/init-map */ "./js/modules/init-map.js");
/* harmony import */ var _modules_init_range_slider__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/init-range-slider */ "./js/modules/init-range-slider.js");
/* harmony import */ var _modules_toggle_filter_mode__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./modules/toggle-filter-mode */ "./js/modules/toggle-filter-mode.js");
/* harmony import */ var _modules_init_product_slider__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./modules/init-product-slider */ "./js/modules/init-product-slider.js");
/* harmony import */ var _modules_init_form_review__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./modules/init-form-review */ "./js/modules/init-form-review.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_show_authorized_menu__WEBPACK_IMPORTED_MODULE_4__["showAuthorizedMenu"])();
    Object(_modules_init_banner_slider__WEBPACK_IMPORTED_MODULE_5__["initBannerSlider"])();
    Object(_modules_init_list_cards_slider__WEBPACK_IMPORTED_MODULE_6__["initListCardsSlider"])();
    Object(_modules_init_list_articles_slider__WEBPACK_IMPORTED_MODULE_7__["initListArticlesSlider"])();
    Object(_modules_init_product_count__WEBPACK_IMPORTED_MODULE_9__["initProductCount"])();
    Object(_modules_init_favourite_click__WEBPACK_IMPORTED_MODULE_10__["initFavouriteClick"])();
    Object(_modules_remove_focus__WEBPACK_IMPORTED_MODULE_11__["removeFocus"])();
    Object(_modules_init_cart_button_click__WEBPACK_IMPORTED_MODULE_12__["initCartButtonClick"])();
    Object(_modules_init_special_banners_slider__WEBPACK_IMPORTED_MODULE_8__["initSpecialBannersSlider"])();
    Object(_modules_init_tabs__WEBPACK_IMPORTED_MODULE_13__["initTabs"])();
    Object(_modules_init_map__WEBPACK_IMPORTED_MODULE_14__["initShopsMap"])();
    Object(_modules_init_range_slider__WEBPACK_IMPORTED_MODULE_15__["initRangeSlider"])();
    Object(_modules_toggle_filter_mode__WEBPACK_IMPORTED_MODULE_16__["toggleFilterMode"])();
    Object(_modules_init_product_slider__WEBPACK_IMPORTED_MODULE_17__["initProductSlider"])();
    Object(_modules_init_form_review__WEBPACK_IMPORTED_MODULE_18__["initFormReview"])();
  });
}); // ---------------------------------
...
/***/ "./js/modules/hide-button-show-all.js":
/*!********************************************!*\
  !*** ./js/modules/hide-button-show-all.js ***!
  \********************************************/
/*! exports provided: hideButtonShowAll */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hideButtonShowAll", function() { return hideButtonShowAll; });
var breakpointSm = window.matchMedia('(max-width: 767px)');
var breakpointMd = window.matchMedia('(max-width: 1023px)');

var hideButtonShowAll = function hideButtonShowAll(slider, numberItemsArray) {
  var compareNumberItems = function compareNumberItems(n) {
    var itemCollection = slider.querySelectorAll('li');
    var sliderButton = slider.closest('section').querySelector('.section-title button');
...
/*!******************************************!*\
  !*** ./js/modules/init-banner-slider.js ***!
  \******************************************/
/*! exports provided: initBannerSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initBannerSlider", function() { return initBannerSlider; });
...
/***/ "./js/modules/init-cart-button-click.js":
/*!**********************************************!*\
  !*** ./js/modules/init-cart-button-click.js ***!
  \**********************************************/
/*! exports provided: initCartButtonClick */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initCartButtonClick", function() { return initCartButtonClick; });
//const cardProductButtonCollection = document.querySelectorAll('.card-product__button:not(.disabled)');
var cardProductButtonCollection = document.querySelectorAll('[data-button]:not(.disabled)');
var cartMenuItem = document.querySelector('[data-link = "cart"]');

var initCartButtonClick = function initCartButtonClick() {
  if (!cardProductButtonCollection.length) {
    return;
  }

  var clickCartButtonHandler = function clickCartButtonHandler(evt) {
    evt.target.closest('button').classList.add('is-none');
    var cartCount = evt.target.closest('[data-product]').querySelector('.product-count'); //cartCount.classList.add('is-showed');

    cartCount.classList.remove('is-none');

    if (cartMenuItem) {
      var count = parseInt(cartMenuItem.getAttribute('data-count'));
      var labelCounter = cartMenuItem.querySelector('.user-menu-item__counter');
  ...
  cardProductButtonCollection.forEach(function (button) {
    return button.addEventListener('click', clickCartButtonHandler);
  });
};
...
/***/ "./js/modules/init-favourite-click.js":
/*!********************************************!*\
  !*** ./js/modules/init-favourite-click.js ***!
  \********************************************/
/*! exports provided: initFavouriteClick */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initFavouriteClick", function() { return initFavouriteClick; });
var favouriteMenuItem = document.querySelector('[data-link = "favourite"]');

var initFavouriteClick = function initFavouriteClick() {
  /*
  if (!favouriteMenuItem) {
    return;
  }
  */
  var clickFavouriteButtonHandler = function clickFavouriteButtonHandler(evt) {
    var targetButton = evt.target.closest('.card-product__favourite');
    ...
    if (targetButton.classList.contains('is-actived')) {
      ...
      if (favouriteMenuItem) {
        var count = parseInt(favouriteMenuItem.getAttribute('data-count'));
        count--;
        favouriteMenuItem.setAttribute('data-count', count);
        var labelCounter = favouriteMenuItem.querySelector('.user-menu-item__counter');
        labelCounter.textContent = count;
      ...
      if (favouriteMenuItem) {
        var _count = parseInt(favouriteMenuItem.getAttribute('data-count'));

        var _labelCounter = favouriteMenuItem.querySelector('.user-menu-item__counter');

        if (_count === 0) {
          _labelCounter.classList.add('is-showed');
        }

        _count++;
        favouriteMenuItem.setAttribute('data-count', _count);
        _labelCounter.textContent = _count;
      }
    }
  };
...
/***/ "./js/modules/init-form-review.js":
/*!****************************************!*\
  !*** ./js/modules/init-form-review.js ***!
  \****************************************/
/*! exports provided: initFormReview */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initFormReview", function() { return initFormReview; });
var rating = document.querySelector('.rating-field');

var initFormReview = function initFormReview() {
  if (!rating) {
    return;
  }

  var clickRatingHandler = function clickRatingHandler(evt) {
    var button = evt.target.closest('form').querySelector('[type=submit]');
...
/***/ "./js/modules/init-list-articles-slider.js":
/*!*************************************************!*\
  !*** ./js/modules/init-list-articles-slider.js ***!
  \*************************************************/
/*! exports provided: initListArticlesSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initListArticlesSlider", function() { return initListArticlesSlider; });
/* harmony import */ var _hide_button_show_all__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hide-button-show-all */ "./js/modules/hide-button-show-all.js");

var listArticlesSliderCollection = document.querySelectorAll('.list-articles--slider');
var numberItemsScreen = [1, 3, 3]; //количество карточек увмещающиеся на мобильном, планшетном и десктопном экранах, чтобы убрать кнопку "Все ..."

var initSwiper = function initSwiper(slider) {
  var swiper; // eslint-disable-next-line no-undef
  ...
  var clickButtonShowAllHandler = function clickButtonShowAllHandler(evt) {
  ...
  var sectionCard = slider.closest('.section');
  sectionCard.addEventListener('click', clickButtonShowAllHandler);
};

var initListArticlesSlider = function initListArticlesSlider() {
  if (!listArticlesSliderCollection.length) {
    return;
  }

  listArticlesSliderCollection.forEach(function (slider) {
    initSwiper(slider);
    Object(_hide_button_show_all__WEBPACK_IMPORTED_MODULE_0__["hideButtonShowAll"])(slider, numberItemsScreen);
  });
};
...
/***/ "./js/modules/init-list-cards-slider.js":
/*!**********************************************!*\
  !*** ./js/modules/init-list-cards-slider.js ***!
  \**********************************************/
/*! exports provided: initListCardsSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initListCardsSlider", function() { return initListCardsSlider; });
/* harmony import */ var _hide_button_show_all__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hide-button-show-all */ "./js/modules/hide-button-show-all.js");

var listCardsSliderCollection = document.querySelectorAll('.list-cards--slider');
var numberItemsScreen = [2, 3, 4]; //количество карточек увмещающиеся на мобильном, планшетном и десктопном экранах, чтобы убрать кнопку "Все ..."
...
var initListCardsSlider = function initListCardsSlider() {
  if (!listCardsSliderCollection.length) {
    return;
  }

  listCardsSliderCollection.forEach(function (slider) {
    initSwiper(slider);
    Object(_hide_button_show_all__WEBPACK_IMPORTED_MODULE_0__["hideButtonShowAll"])(slider, numberItemsScreen);
  });
};
...
/*!********************************!*\
  !*** ./js/modules/init-map.js ***!
  \********************************/
/*! exports provided: initShopsMap */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initShopsMap", function() { return initShopsMap; });
var dataShops = [{
  container: "map1",
  objects: [{
...
var initShopsMapSection = function initShopsMapSection(dataShopsItem) {
  var map = document.querySelector("#".concat(dataShopsItem.container));
  ...
  function init() {
    var myMap = new ymaps.Map(dataShopsItem.container, {
      center: [55.80503253, 37.51511999],
      zoom: 13,
      controls: []
    });
    dataShopsItem.objects.forEach(function (item) {
      var myPlacemark;
...
var initShopsMap = function initShopsMap() {
  dataShops.forEach(function (dataItem) {
...
/***/ "./js/modules/init-product-count.js":
/*!******************************************!*\
  !*** ./js/modules/init-product-count.js ***!
  \******************************************/
/*! exports provided: initProductCount */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initProductCount", function() { return initProductCount; });
var initProductCount = function initProductCount() {
  var counters = document.querySelectorAll(".product-count");
  ...
  counters.forEach(function (counter) {
    var countInput = counter.querySelector("input");
    var decreaseButton = counter.querySelector("[data-count='decrease']");
    var increaseButton = counter.querySelector("[data-count='increase']");

    var decreaseCount = function decreaseCount() {
      var inputValue = parseInt(countInput.value);
...
var initSwiper = function initSwiper(slider) {
  // eslint-disable-next-line no-undef
  var mainSlider = slider.querySelector('.product-slider__main');
  var thumbsSlider = slider.querySelector('.product-slider__thumbs');
...
var initRangeSlider = function initRangeSlider() {
  ...
  var slider = rangeFilter.querySelector('#range-slider');
  var input0 = rangeFilter.querySelector('#input-with-keypress-0');
  var input1 = rangeFilter.querySelector('#input-with-keypress-1');
  var inputs = [input0, input1];
  var buttonClear = rangeFilter.querySelector('.range-filter__header button');
...
/***/ "./js/modules/init-special-banners-slider.js":
/*!***************************************************!*\
  !*** ./js/modules/init-special-banners-slider.js ***!
  \***************************************************/
/*! exports provided: initSpecialBannersSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSpecialBannersSlider", function() { return initSpecialBannersSlider; });
/* harmony import */ var _hide_button_show_all__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hide-button-show-all */ "./js/modules/hide-button-show-all.js");

var listSpecialBannersSliderCollection = document.querySelectorAll('.special-banners--slider');
var numberItemsScreen = [1, 2, 2]; //количество карточек увмещающиеся на мобильном, планшетном и десктопном экранах, чтобы убрать кнопку "Все ..."
...
var initSpecialBannersSlider = function initSpecialBannersSlider() {
  if (!listSpecialBannersSliderCollection.length) {
    return;
  }

  listSpecialBannersSliderCollection.forEach(function (slider) {
    initSwiper(slider);
    Object(_hide_button_show_all__WEBPACK_IMPORTED_MODULE_0__["hideButtonShowAll"])(slider, numberItemsScreen);
  });
};
...
/***/ "./js/modules/remove-focus.js":
/*!************************************!*\
  !*** ./js/modules/remove-focus.js ***!
  \************************************/
/*! exports provided: removeFocus */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./js/modules/show-authorized-menu.js":
/*!********************************************!*\
  !*** ./js/modules/show-authorized-menu.js ***!
  \********************************************/
/*! exports provided: showAuthorizedMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showAuthorizedMenu", function() { return showAuthorizedMenu; });
var userAuthorized = document.querySelector('.user-authorized');
var breakpoint = window.matchMedia('(max-width:1279px)');

var showAuthorizedMenu = function showAuthorizedMenu() {
  if (!userAuthorized) {
    return;
  }

  var arrowButton = userAuthorized.querySelector('.user-authorized__arrow-container');
  var userWrapLinks = userAuthorized.querySelector('.user-authorized__wrap-links');
  ...
  var openMenu = function openMenu() {
    ...
    var height = userWrapLinks.scrollHeight;
...
/***/ "./js/modules/toggle-filter-mode.js":
/*!******************************************!*\
  !*** ./js/modules/toggle-filter-mode.js ***!
  \******************************************/
...
var toggleFilterMode = function toggleFilterMode() {
  ...
  var filtersWrapper = filters.querySelector('.filters__wrapper');
  var filtersContent = filters.querySelector('.filters__content');
  var filtersCloseButton = filters.querySelector('.filters__close-button');
  var modeModal;
  ...
  var toggleMode = function toggleMode() {
    if (!modeModal) {
      ...
      Object(_modals_init_modals__WEBPACK_IMPORTED_MODULE_0__["initModals"])();
      modeModal = true;
    } else {
      ...
      var _filtersOverlay = filtersWrapper.querySelector('.modal__overlay');

      if (_filtersOverlay) {
        _filtersOverlay.remove();
      }
